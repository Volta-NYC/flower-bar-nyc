...
export default function About() { return <PageShell>
  ...
  <section className="mission-strip"><Sparkles/><p>Her mission is to share the joy of truly custom floral artistry, turning every milestone into an unforgettable, happy surprise.</p><Sparkles/></section>
  ...
  <section className="about-cta"><div className="photo-frame"><Image src="/images/flowerbar-hero.jpg" alt="An original Flower Bar NYC seasonal arrangement" fill sizes="(max-width: 800px) 80vw, 36vw"/></div><div><p className="kicker">Have a moment in mind?</p><h2>Let’s make it <i>bloom.</i></h2><Link className="button" href="/contact">Talk to Sherry <ArrowUpRight size={16}/></Link></div></section>
  </PageShell> }

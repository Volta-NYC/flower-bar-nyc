...
export default function About() { return <PageShell>
  ...
  <section className="values section-pad"><div className="section-intro reveal"><p className="kicker">2 · The Flower Bar point of view</p><div><h2>Designed to feel<br/><i>like you.</i></h2><p className="section-deck">A simple philosophy guides every stem, color choice, and finishing touch.</p></div></div><div className="value-grid"><article className="reveal"><span>1</span><h3>Season over sameness</h3><p>We follow what is fresh and beautiful now, so every piece has its own personality.</p></article><article className="reveal delay-one"><span>2</span><h3>Feeling over formula</h3><p>Your occasion, color story, and budget shape the design—not a catalog photo.</p></article><article className="reveal delay-two"><span>3</span><h3>Joy in the details</h3><p>From the first stem to the final delivery, every choice is made with care.</p></article></div></section>
